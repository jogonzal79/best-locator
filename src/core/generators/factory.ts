...
import { ISelectorGenerator } from '../processing/types.js';
...
// AGREGAR ESTA IMPORTACIÓN Y CONFIGURACIÓN
...
export class GeneratorFactory {
  ...
  static create(framework: string, config: BestLocatorConfig): ISelectorGenerator {
    // Log para verificar que está funcionando
    ...
    if (!useNew) {
      ...
      return new SelectorGenerator(config);
    }
